...
val teamDokumenthåndteringAvroSchemaVersion by extra("58cb38b3")
...
dependencies {
    ...
    implementation("no.nav.doknotifikasjon:teamdokumenthandtering-avro-schemas:$teamDokumenthåndteringAvroSchemaVersion")
