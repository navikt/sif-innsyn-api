...
class OmsorgspengerUtvidetRettHendelseKonsumentIntegrasjonsTest {
    ...
    fun setUp() {
        ...
        omsorgspengerUtvidetRettProducer = embeddedKafkaBroker.opprettKafkaProducer()
    }
    ...
    fun `Konsumere hendelse om Omsorgspenger - Utvidet rett, persister og tilgjengligjør gjennom API`() {
        ...
        omsorgspengerUtvidetRettProducer.leggPåTopic(defaultHendelse(søknadIdKey = "soknadId"), OMP_UTVIDET_RETT, mapper)
