package no.nav.sifinnsynapi.omsorgspenger.utbetaling
...
@EmbeddedKafka( // Setter opp og tilgjengligjør embeded kafka broker
        count = 3,
        topics = [Topics.OMP_UTBETALING_ARBEIDSTAKER, Topics.K9_DITTNAV_VARSEL_BESKJED],
...
class OmsorgspengerutbetalingArbeidstakerHendelseKonsumentTest {
    ...
    companion object {
        private val log: Logger = LoggerFactory.getLogger(OmsorgspengerutbetalingArbeidstakerHendelseKonsumentTest::class.java)
    }
